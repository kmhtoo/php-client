 ...
 * @author knplabs.com
 */
abstract class Jirafe_AdminApi_Resource
{
    private $id;
    private $collection;
    private $client;
     ...
     * @param   Jirafe_AdminApi_Collection   $collection collection instance
     * @param   Jirafe_AdminApi_Client           $client     API client
     */
    public function __construct($id, Jirafe_AdminApi_Collection $collection, Jirafe_AdminApi_Client $client)
    {
        $this->id = $id;
     ...
     *
     * @return  Jirafe_AdminApi_Collection
     */
