...
/**
 * Jirafe Admin API client.
 *
 * @author knplabs.com
 */
class Jirafe_AdminApi_Client
{
    private $token;
    private $connection;
     ...
     *                      collection
     * @return  Jirafe_AdminApi_Collection_Applications|Jirafe_AdminApi_Resource_Application
     */
    public function applications($id = null)
    {
        $applications = new Jirafe_AdminApi_Collection_Applications($this);
     ...
     *                      collection
     * @return  Jirafe_AdminApi_Collection_Users|Jirafe_AdminApi_Resource_User
     */
    public function users($id = null)
    {
        $users = new Jirafe_AdminApi_Collection_Users($this);
