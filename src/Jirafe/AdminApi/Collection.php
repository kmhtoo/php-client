 ...
 * @author knplabs.com
 */
abstract class Jirafe_AdminApi_Collection
{
    private $parent;
    private $client;
     ...
     *
     * @param   Jirafe_AdminApi_Resource $parent parent resource
     * @param   Jirafe_AdminApi_Client       $client API client
     */
    public function __construct(Jirafe_AdminApi_Resource $parent = null, Jirafe_AdminApi_Client $client)
    {
        $this->parent = $parent;
        $this->client = $client;
    }
     ...
     *
     * @return  Jirafe_AdminApi_Resource
     */
