 ...
 * @author knplabs.com
 */
class Jirafe_AdminApi_Collection_Sites extends Jirafe_AdminApi_Collection
{
    /**
     * Initializes sites collection.
     *
     * @param   Jirafe_AdminApi_Resource_Application $parent application resource
     * @param   Jirafe_AdminApi_Client                   $client API client
     */
    public function __construct(Jirafe_AdminApi_Resource_Application $parent, Jirafe_AdminApi_Client $client)
    {
     ...
     * @param   integer $id
     *
     * @return  Jirafe_AdminApi_Resource_Site
     */
    public function get($id)
    {
        return new Jirafe_AdminApi_Resource_Site($id, $this, $this->getClient());
    }
