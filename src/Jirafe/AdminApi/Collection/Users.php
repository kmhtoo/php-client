 ...
 * @author knplabs.com
 */
class Jirafe_AdminApi_Collection_Users extends Jirafe_AdminApi_Collection
{
    /**
     ...
     *
     * @return  Jirafe_AdminApi_Resource_User
     */
    public function get($username)
    {
        return new Jirafe_AdminApi_Resource_User($username, $this, $this->getClient());
    }
